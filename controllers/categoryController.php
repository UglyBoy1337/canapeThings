...
class CategoryController extends Controller
{
    ...
    function parseQuery()
    {
        ...
        if(isset($_POST['search_product'])){ 
            $this->searchProduct($_POST['search_id']);
        }
        if(isset($_POST['sortBy']) || isset($_POST['sortDefault'])){ 
            $this->sortBy($_POST['orderBy']);
        }
    }
    ...
    function searchProduct($id)
    {
        ...
        if(is_numeric($id) && $id >= 0){
            ...
            if($prodInf == null) { 
                $this->errmsg = "Ошибка поиска товара"; 
            }else{
